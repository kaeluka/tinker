...
Treat these agents as your friendly coworkers. They have information you don't have and telling them what you're going to do, then doing it while waiting for their response to appear will ensure the
product of your work will be much better.
...
- Other agents: the compact index and edge reasons tell you what an agent is *responsible for* — enough to write a useful message.
