...
📁 `src/goal_session.rs` — `run_goal`, `goal_init_message`, `build_neighborhood_table`, summary request; `test_spec_goal_init_has_neighborhood_table`, `test_spec_goal_init_neighbors_pullable_on_demand`, `test_spec_goal_init_no_subgoals_section`, `test_spec_goal_init_no_neighborhood_table_when_isolated`  
